...
const allowedFiles = new Set([
  ...
  "tools/audit-ui-consistency.mjs",
  "tools/audit-public-sitemap.mjs",
  "tools/apply-site-shell.mjs",
  "tools/verify-build.mjs",
  "tools/collect-scene-signals.mjs",
  "tools/lib/site-shell.mjs",
  "tools/style-rag/lib.mjs",
  "tools/style-rag/reference-sources.mjs",
  "tools/style-rag/init-style-db.mjs",
  "tools/style-rag/ingest-style-references.mjs",
  "tools/style-rag/import-site-copy.mjs",
  "tools/style-rag/audit-copy-style.mjs",
  "tools/style-rag/export-style-json.mjs",
  "tools/style-rag/search-style.mjs",
